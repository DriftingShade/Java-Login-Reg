...
<body>
	<div class="container mx-auto text-center my-3">
		<h1>Welcome!</h1>
		<h3 class="my-3">Join our growing community</h3>
        	...
        	<div class="card-body">
          	...
          	<form:form action="/register" method="post" modelAttribute="newUser">
            	<ul class="list-group list-group-flush form-control">
              		<li class="list-group-item text-center">
                		...
                		<form:input path="userName" class="form-control my-3"/>
                		<form:errors path="userName"/>
              		</li>
              		<li class="list-group-item text-center">
               			<form:label path="email" class="form-label">Email:</form:label>
               			<form:input path="email" class="form-control my-3"/>
               			<form:errors path="email"/>
              		</li>
              		<li class="list-group-item" class="form-label">
              			<form:label path="password" class="form-label">Password:</form:label>
               			<form:input path="password" type="password" class="form-control my-3"/>
               			<form:errors path="password"/>
              		</li>
              		<li class="list-group-item" class="form-label">
               			<form:label path="confirm" class="form-label">Confirm:</form:label>
               			<form:input path="confirm" type="password" class="form-control my-3"/>
      		...
      		<div class="card" style="width: 18rem">
      			<div class="card-body">
              		...
              		<li class="list-group-item text-center">
               			<form:label path="password" class="form-label">Password:</form:label>
               			<form:input type="password" path="password" class="form-control my-3"/>
               			<form:errors path="password"/>
              		</li>
              		</ul>
